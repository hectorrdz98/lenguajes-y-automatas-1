...
lastL = 0                   # Last lexic index that we analisis
        ...
        if actState in turing:
            ...
            if actState in errors:
                print('\n{}{}{} near {}{} {}{} in line {}{}{}'.format(
                    ...
                    textColors['orange'], lexic[lastL][1], lexic[currentL][1], textColors['red'],
                    textColors['orange'], lexic[currentL][4] + 1,
                    textColors['reset']
                ))
                goodLexic = False
                break
